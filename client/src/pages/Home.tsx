    ...
    <Layout>
      <div className="relative min-h-[calc(100vh-80px)] flex items-center justify-center overflow-hidden">
        ...
        <div className="container px-4 text-center z-10 space-y-6">
          ...
          {/* Headline */}
          <h1 className="text-5xl md:text-8xl font-display font-bold tracking-tight leading-tight">
            .NET <span className="text-primary">Full Stack</span> Developer
          </h1>

          {/* Tech stack hint */}
          <p className="text-sm uppercase tracking-widest text-primary/60">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link
                href="/projects"
                className="group relative px-12 py-5 bg-primary text-primary-foreground font-bold rounded-xl overflow-hidden transition-all hover:shadow-[0_0_30px_rgba(0,255,255,0.4)] hover:-translate-y-1"
              >
